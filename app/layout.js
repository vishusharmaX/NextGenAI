...
export const metadata = {
  ...
  title: {
    default: 'NextGen AI - AI-Powered Interview Preparation',
    template: '%s | NextGen AI'
  },
  ...
  openGraph: {
    ...
    title: 'NextGen AI - AI-Powered Interview Preparation',
    description: 'Elevate your interview skills with AI-powered mock interviews. Get personalized coaching, real-time feedback, and boost your confidence.',
    siteName: 'NextGen AI',
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'NextGen AI - Revolutionizing Interview Preparation'
      }
    ]
  },
